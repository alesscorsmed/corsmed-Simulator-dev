function [acqData] = initializeAcq()
%
% DATA.ACQUISITIONDATA.INITIALIZEACQ
%
...
acqData.encOrder        = 'std'; % encoding order: std / centric / edge

acqData.xPadFactor      = 1; % K-space padding before IFT, to increase image resolution
