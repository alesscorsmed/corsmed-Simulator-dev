...
simulatorSpecs  = '';
%% for test
testFolder     = '/efs-mount-point/S20/REGRESSION/eduTool'; % main folder
testTag        = 'defaultParamsVarys'; % sub-folder for different experiment configurations
...
while waitForExperiment
    ...
    experimentName = sprintf('%s_%s_%s_%s',...
        ...
        testName, expControl.fileTimeStamp);
    expControl.name = experimentName;
