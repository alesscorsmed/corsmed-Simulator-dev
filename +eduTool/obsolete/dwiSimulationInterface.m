function [Sx,Sy,Sz] = dwiSimulationInterface(...
...
spinModel.slice{1}.model.xDiffusion  = ...
    anatModel_struct.tissueDiff(anatModel_struct.model_new,1);
spinModel.slice{1}.model.yDiffusion  = ...
    anatModel_struct.tissueDiff(anatModel_struct.model_new,2);
spinModel.slice{1}.model.zDiffusion  = ...
    anatModel_struct.tissueDiff(anatModel_struct.model_new,3);
...
if isempty(pulseSeq_struct.dwPulseSequence)
    % initialize
    ...
    % perform DWI
    pulseSequence = pulseSeq_struct.dwPulseSequence;
