...
kspace(1,3) = 32;               % defines the size of k-space along y direction
...
[pulse_sequence,isInKspace,pulse_sequence_TR,soft_crushers,N_pulse,N_TR,...
    ...
    kspace,FOV,receiverBW,G_max,TR,TE,dt,gamma,MPRAGETR,RFprepAngle,...
    segments,TI,IRtype,IRduration);
...
info = pulseSequenceGenerator.createInfoStruct_GRE_3D(kspace,FOV,dt,receiverBW,TR,TE,...
    kspace_times,f0,sliceThickness,kspace,FOV,encodedkSpace);
