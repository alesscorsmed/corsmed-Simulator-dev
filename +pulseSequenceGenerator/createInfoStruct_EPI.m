function info = createInfoStruct_EPI(kspace,FOV,dt,receiverBW,...
    kspace_times,f0,sliceThickness,ESP,acquiredkspace,acquiredFOV,...
    partialFourierStruct,encodedkSpace)
...
info.pulseSequence.EchoSpacing      = ESP;
info.pulseSequence.EchoTrainLength  = acquiredkspace(1,2);
