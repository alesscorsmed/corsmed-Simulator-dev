...
[pulse_sequence,isInKspace,pulse_sequence_TR,soft_crushers,N_pulse,N_TR,...
    kspace_times,BW_rf,TR_times,TRmin,PulseqDuration] = ...
    pulseSequenceGenerator.IRSEgenerator(RFmatrix1,RFmatrix2,kspace,FOV,...
    receiverBW,G_max,TR,TE,TI,IRtype,IRduration,dt,gamma);
