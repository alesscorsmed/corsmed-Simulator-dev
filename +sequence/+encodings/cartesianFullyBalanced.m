function [time,signalFE,signalPE,signalSE,signalRX,dt,effTE,rxLimits] = ...
    cartesianFullyBalanced( receiverBW, fovFE, fovPE, fovSE,...
    numFE, numPE, numSE, ...
...
%   FE:  -HalfRewind  +Encoding  -HalfRewind
...
%========================  CORSMED AB © 2020 ==============================
%
functionName = 'sequence.encodings.cartesianFullyBalanced';
...
fePlatLimits = fePlatLimits + (lenFeDelay+lenFeRw); 
% readout placement
