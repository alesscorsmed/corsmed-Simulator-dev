function [pulseSequence] = spinEcho3D(...
    acquisition, encoding, mrSystem, expControl)
%
% SEQUENCE.FAMILYSE.SPINECHO3D
%
%	Generates a Standard 3D Spin Echo sequence.
%
% INPUT
%   acquisition         
%   mrSystem        
...
%========================  CORSMED AB © 2020 ==============================
%
functionName = 'sequence.familySE.spinEcho3D';
...
pulseSequence.name    	= 'Spin Echo 3D';
pulseSequence.type     	= 'SE3D';
