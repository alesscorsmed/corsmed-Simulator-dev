...
% define the class
classdef epiTest < matlab.unittest.TestCase
    ...
    properties (TestParameter)
        ...
        numPE               = { 128,        96,                 64,                 64,         255,        196,                128};  % phase encodings
    ...
    methods (Test, ParameterCombination = 'sequential')
        ...
        function runEpiEdgeTest(testCase,...
                fovFE,...
                fovPE,...
                numFE,...
                numPE,...
            ...
            % fixed vars
            acquisition.data.pulseSeqFamilyName = 'EPI';
            acquisition.data.pulseSeqActualName = 'EPI';
            % 
        ...
        function runEpiGeneralTest(testCase)
            ...
            for lfovFE = linspace(0.1, 0.4, 6)
            for lfovPE = linspace(0.1, 0.4, 6)
            for lnumFE = [64 128 256 512]
            for lnumPE = [64 96  128 192]
            for lrxBW = linspace(50000, 250000,6)
            ...
            try
                ...
                if strcmpi(errorInfo{1}, 'userwarning')
                    ...
                    %% otherwise error
                    fprintf(1, '\n EPI ERROR: %s (%d) : %s', ME.stack(1).file, ME.stack(1).line, ME.message);
                    fprintf(1, ['\n    PARAMETERS:',...
