function [tissueMask] = interpolateTissue( rSlice, anatomicalModel, dbgControl )
%
% SIMMODEL.INTERPOLATION.INTERPOLATETISSUE
%
...
%========================  CORSMED AB © 2020 ==============================
%
functionName = 'simModel:interpolation:interpolateTissue';
% check args
if (nargin < 4)
...
% optional arguments
if (nargin < 3) || isempty(dbgControl)
    dbgControl.mode = 0;
    dbgControl.file = [];
end
% info for debugging
...
if  dbgControl.mode
    tTotal = toc(tTotal);
    fprintf(fid, '\n%s : tissue mask interpolation done', functionName);
