...
%
%	Test diffusion effects on homogeneus cube using a PG reversed sequence
%   +Gradient -- wait -- -Gradient (no RFs)
%
% INPUT
...
valuesTAU = [25, 50, 75, 100]*1e-3;
valuesAG  = [0.001, 0.010, 0.020, 0.030];
valuesTG  = [5, 10, 15, 20]*1e-3; 
